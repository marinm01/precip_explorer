...
ggplot(daily, aes(x=date, y = daily_rain)) + 
  geom_point() + 
  scale_y_log10()+
  labs(x = "Date", y = "Daily Rainfall", title= "Daily Rainfall for FNL Airport")


```

#Download the rest of the data for the CO sites
```{r}
for (i in co_stations) {
  
}
stats <- riem_measures(station = co_stations,
                   date_start = '1987-05-01',
                   date_end = '1992-11-01')
